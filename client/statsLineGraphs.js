      ...
      return (
        <div className="statsPageContainer">
          ...
          <div className="chartsContainer">
            <LineChart className='StatsScoreGraph' data={this.state.data} margins={margins} chartSeries={this.state.chartSeries1} width={1100} height={500} title={'Score History'} x={x} xScale={xScale} yAxisClassName={'lineY'} xAxisClassName={'lineX'} yLabel={'Scores'} //x axis includes first and last day of play (for time range)
