...
ReactDOM.render((
  <Router history={browserHistory}>
    <Route path="/" component={App}>
      ...
      <Route path="connect/login/facebook/success" component={FacebookLogin}/>
      <Route path="connect/login/facebook(/:error)" component={FacebookLogin}/>
